...
from app.schemas.feedback import FeedbackRequest, FeedbackResponse, FeedbackListResponse  # Import Pydantic models
...
async def submit_feedback(request: FeedbackRequest, db: Session = Depends(get_db)):
    try:
        ...
        return FeedbackResponse(message="Feedback submitted successfully.", feedback_id=new_feedback.id)
